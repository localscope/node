{
  'variables': {
    ...
    'openssl_sources_BSD-x86_64': [
      './config/archs/BSD-x86_64/no-asm/providers/common/der/der_sm2_gen.c',
      './config/archs/BSD-x86_64/no-asm/providers/common/der/der_digests_gen.c',
      './config/archs/BSD-x86_64/no-asm/providers/common/der/der_dsa_gen.c',
      './config/archs/BSD-x86_64/no-asm/providers/common/der/der_ec_gen.c',
      './config/archs/BSD-x86_64/no-asm/providers/common/der/der_ecx_gen.c',
      './config/archs/BSD-x86_64/no-asm/providers/common/der/der_rsa_gen.c',
      './config/archs/BSD-x86_64/no-asm/providers/common/der/der_wrap_gen.c',
